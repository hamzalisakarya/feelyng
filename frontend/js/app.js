const translations = {
    de: {
        ...
        carText: "Wir können Ihnen einen Vergleichs- bzw. Abschlusslink zur Verfügung stellen und Sie bei technischen Fragen zum Ausfüllen unterstützen. Die Auswahl des Versicherungsprodukts und die endgültige Entscheidung treffen Sie selbst.",
        carNote: "Keine Versicherungsberatung oder individuelle Produktempfehlung.",
        carCta: "Mehr zum Ablauf →",
    ...
    tr: {
        ...
        carText: "Size karşılaştırma veya başvuru bağlantısı gönderebilir ve formdaki alanları doldururken teknik konularda yardımcı olabiliriz. Sigorta ürününü siz seçersiniz ve nihai karar tamamen size aittir.",
        carNote: "Sigorta danışmanlığı veya kişiye özel ürün tavsiyesi verilmez.",
        carCta: "Süreç hakkında bilgi →",
